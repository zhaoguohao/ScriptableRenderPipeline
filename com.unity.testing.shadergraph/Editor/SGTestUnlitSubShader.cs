...
namespace UnityEditor.ShaderGraph.Tests
{
    public class SGTestUnlitSubShader : IUnlitSubShader
    {
        ...
        public string GetSubshader(IMasterNode masterNode, GenerationMode mode, List<string> sourceAssetDependencyPaths = null)
        {
            ...
            {
                // SGTestUnlitSubShader.cs
                sourceAssetDependencyPaths.Add(AssetDatabase.GUIDToAssetPath("4a825161b00055941b952ffbb1217d2d"));
            }

            var templatePath = GetTemplatePath("sgtestUnlitPass.template");
            ...
            UnlitMasterNode unlitMasterNode = masterNode as UnlitMasterNode;

            Pass pass = m_unlitPass;
            ShaderStringBuilder subShader = new ShaderStringBuilder();
            subShader.AppendLine("SubShader");

            using(subShader.BlockScope())
            {
                subShader.AppendLine("Tags { \"RenderPipeline\"=\"ShaderGraphTestPipeline\" }");
                ...
                subShader.AppendLines(GetShaderPassFromTemplate(templateText, unlitMasterNode, pass, mode, materialOptions));
        ...
        public bool IsPipelineCompatible(RenderPipelineAsset rp)
        {
            return rp is TestPipelineAsset;
        }

        static string GetTemplatePath(string templateName)
        {
            var pathSegments = new[] { "Packages", "com.unity.testing.shadergraph", "Editor", templateName };
