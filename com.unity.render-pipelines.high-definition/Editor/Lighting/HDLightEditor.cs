...
namespace UnityEditor.Experimental.Rendering.HDPipeline
{
    ...
    sealed partial class HDLightEditor : LightEditor
    {
        ...
        void DrawFeatures()
        {
            bool disabledScope = m_LightShape == LightShape.Tube || (m_LightShape == LightShape.Rectangle && settings.isRealtime) || (m_LightShape == LightShape.Disc && settings.isRealtime);
