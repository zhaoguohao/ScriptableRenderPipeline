...
namespace UnityEditor.Experimental.Rendering.HDPipeline
{
    static partial class HDRenderPipelineUI
    {
        ...
        static readonly GUIContent k_SupportVxShadowsContent = EditorGUIUtility.TrTextContent("Vx Shadows", "When enabled, HDRP allocates Shader variants and memory for voxelized shadows. This allows you to use voxelized shadows in your Unity Project."); //seongdae;vxsm
