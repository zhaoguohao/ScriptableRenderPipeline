...
namespace UnityEngine.Experimental.Rendering.HDPipeline
{
    ...
    public class GBufferManager : MRTBufferManager
    {
        ...
        public override void CreateBuffers()
        {
            ...
            {
                m_RTs[gbufferIndex] = RTHandles.Alloc(Vector2.one, colorFormat: rtFormat[gbufferIndex], sRGB: sRGBFlags[gbufferIndex], filterMode: FilterMode.Point, name: string.Format("GBuffer{0}", gbufferIndex), enableRandomWrite: enableWrite[gbufferIndex], requireStereoSupport: false); // Deferred unsupported in VR
