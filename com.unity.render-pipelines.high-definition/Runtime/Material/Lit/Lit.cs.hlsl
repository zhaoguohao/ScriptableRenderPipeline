...
#define DEBUGVIEW_LIT_SURFACEDATA_PERCEPTUAL_SMOOTHNESS (1006)
...
#define DEBUGVIEW_LIT_SURFACEDATA_SUBSURFACE_MASK (1012)
...
#define DEBUGVIEW_LIT_SURFACEDATA_IRIDESCENCE_THICKNESS (1017)
#define DEBUGVIEW_LIT_SURFACEDATA_IRIDESCENCE_MASK (1018)
#define DEBUGVIEW_LIT_SURFACEDATA_GEOMETRIC_NORMAL (1019)
#define DEBUGVIEW_LIT_SURFACEDATA_GEOMETRIC_NORMAL_VIEW_SPACE (1020)
#define DEBUGVIEW_LIT_SURFACEDATA_INDEX_OF_REFRACTION (1021)
#define DEBUGVIEW_LIT_SURFACEDATA_IOR (1022)
#define DEBUGVIEW_LIT_SURFACEDATA_TRANSMITTANCE_COLOR (1023)
#define DEBUGVIEW_LIT_SURFACEDATA_TRANSMITTANCE_ABSORPTION_DISTANCE (1024)
#define DEBUGVIEW_LIT_SURFACEDATA_AT_DISTANCE (1025)
#define DEBUGVIEW_LIT_SURFACEDATA_TRANSMITTANCE_MASK (1026)
