Shader "HDRP/LayeredLit"
{
    Properties
    {
        ...
        [HideInInspector] _DiffusionProfileAsset0("Dissuion Profile Asset0", Vector) = (0, 0, 0, 0)
        [HideInInspector] _DiffusionProfileHash0("Dissuion Profile Hash0", Float) = 0
        [HideInInspector] _DiffusionProfileAsset1("Dissuion Profile Asset0", Vector) = (0, 0, 0, 0)
        [HideInInspector] _DiffusionProfileHash1("Dissuion Profile Hash0", Float) = 0
        [HideInInspector] _DiffusionProfileAsset2("Dissuion Profile Asset0", Vector) = (0, 0, 0, 0)
        [HideInInspector] _DiffusionProfileHash2("Dissuion Profile Hash0", Float) = 0
        [HideInInspector] _DiffusionProfileAsset3("Dissuion Profile Asset0", Vector) = (0, 0, 0, 0)
        [HideInInspector] _DiffusionProfileHash3("Dissuion Profile Hash0", Float) = 0
