...
list.Add(new DebugUI.FloatField
{
    ...
    getter = () => data.lightingDebugSettings.upscaleSigmaRange,
    setter = (v) => data.lightingDebugSettings.upscaleSigmaRange = v,
    min = () => 0.0001f,
    max = () => 2.0f,
});
...
list.Add(new DebugUI.FloatField
{
    ...
    getter = () => data.lightingDebugSettings.upscaleSigmaDepth,
    setter = (v) => data.lightingDebugSettings.upscaleSigmaDepth = v,
    min = () => 0.0001f,
    max = () => 2.0f,
});
