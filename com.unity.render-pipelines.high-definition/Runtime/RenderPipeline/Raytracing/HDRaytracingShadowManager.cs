...
namespace UnityEngine.Experimental.Rendering.HDPipeline
{
    ...
    public class HDRaytracingShadowManager
    {
        ...
        static int m_EstimateNoiseKernel;
        static int m_DenoiseKernel;
        ...
        public bool RenderAreaShadows(HDCamera hdCamera, CommandBuffer cmd, ScriptableRenderContext renderContext, uint frameCount)
        {
            ...
            bool invalidState = rtEnvironement == null || blueNoise == null || !rtEnvironement.raytracedShadows || shadowsShader  == null || shadowFilter == null || hdCamera.frameSettings.litShaderMode != LitShaderMode.Deferred
