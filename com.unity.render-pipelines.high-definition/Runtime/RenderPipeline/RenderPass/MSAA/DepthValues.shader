Shader "Hidden/HDRenderPipeline/DepthValues"
{
    HLSLINCLUDE
        ...
        TEXTURE2DMS_ARRAY_TYPE(float4, _NormalTextureMS);
        ...
        FragOut Frag1X(Varyings input)
        {
            ...
            float depthVal = LOAD_TEXTURE2D_ARRAY_MSAA(_DepthTextureMS, pixelCoords, unity_StereoEyeIndex, 0).x;
            fragO.depthValues = float4(depthVal, depthVal, depthVal, 0.0f);
            fragO.normal = LOAD_TEXTURE2D_ARRAY_MSAA(_NormalTextureMS, pixelCoords, unity_StereoEyeIndex, 0);
        ...
        FragOut Frag2X(Varyings input)
        {
            ...
            {
                float depthVal = LOAD_TEXTURE2D_ARRAY_MSAA(_DepthTextureMS, pixelCoords, unity_StereoEyeIndex, sampleIdx).x;
