Shader "Hidden/HDRenderPipeline/DepthValues"
{
    HLSLINCLUDE
        ...
        FragOut Frag1X(Varyings input)
        {
            ...
            float depthVal = LOAD_TEXTURE_MSAA(_DepthTextureMS, pixelCoords, 0).x;
            fragO.depthValues = float4(depthVal, depthVal, depthVal, 0.0f);
            fragO.normal = LOAD_TEXTURE_MSAA(_NormalTextureMS, pixelCoords, 0);
        ...
        FragOut Frag2X(Varyings input)
        {
            ...
            {
                float depthVal = LOAD_TEXTURE_MSAA(_DepthTextureMS, pixelCoords, sampleIdx).x;
