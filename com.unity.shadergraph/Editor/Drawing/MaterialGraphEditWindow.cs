...
namespace UnityEditor.ShaderGraph.Drawing
{
    class MaterialGraphEditWindow : EditorWindow
    {
        ...
        public void ToSubGraph()
        {
            ...
            var nodes = graphView.selection.OfType<IShaderNodeView>().Where(x => !(x.node is PropertyNode)).Select(x => x.node as INode).ToArray();
            ...
            var copyPasteGraph = new CopyPasteGraph(
                    ...
                    graphView.selection.OfType<IShaderNodeView>().Where(x => !(x.node is PropertyNode)).Select(x => x.node as INode),
            ...
            graphObject.graph.RemoveElements(
                graphView.selection.OfType<IShaderNodeView>().Select(x => x.node as INode),
