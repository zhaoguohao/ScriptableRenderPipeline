...
{
    class BlackboardFieldSubgraphInputView : VisualElement
    {
        readonly BlackboardField m_BlackboardField;
        readonly GraphData m_Graph;

        MaterialSlot m_Property;
        ...
        public BlackboardFieldSubgraphInputView(BlackboardField blackboardField, GraphData graph, MaterialSlot property)
        {
