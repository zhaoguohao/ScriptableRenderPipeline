...
{
    [Title("Test Nodes", "Port Test")]
    class PortTestNode : ShaderNode, IGeneratesBodyCode
    {
        ...
        OutPortDescriptor m_Port31 = new OutPortDescriptor(31, "Out", ConcreteSlotValueType.Vector1);
        ...
        public override void Setup(ref NodeSetupContext context)
        {
            context.CreateType(new NodeTypeDescriptor
            {
                ...
                outPorts = new OutPortDescriptor[]
                {
                    m_Port31
                }
            });
